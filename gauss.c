    ...
    if(N==1)
    {
        ...
        for(i=0; i<4; i++)
        {
            ...
            if (cadde_baslangic_sec[0] == 't' && cadde_yon_sec[0] == 'x')
            {
                ...
                al_draw_line(331,120,335,124,al_map_rgb(255,204,51),3);
                al_flip_display();
            }
            if (cadde_baslangic_sec[0] == 'x' && cadde_yon_sec[0] == 't')
            {
                ...
                al_draw_line(285,177,289,181,al_map_rgb(255,204,51),3);
                al_flip_display();
            ...
            if (cadde_baslangic_sec[1] == 'x' && cadde_yon_sec[1] == 'y')
            {
                ...
                al_draw_line(416,175,420,179,al_map_rgb(255,204,51),3);
                al_flip_display();
            }
            if (cadde_baslangic_sec[1] == 'y' && cadde_yon_sec[1] == 'x')
            {
                ...
                al_draw_line(366,117,370,121,al_map_rgb(255,204,51),3);
                al_flip_display();
            }
            ...
            if (cadde_baslangic_sec[2] == 'y' && cadde_yon_sec[2] == 'z')
            {
                ...
                al_draw_line(362,246,366,250,al_map_rgb(255,204,51),3);
                al_flip_display();
            }
            if (cadde_baslangic_sec[2] == 'z' && cadde_yon_sec[2] == 'y')
            {
                ...
                al_draw_line(414,192,418,196,al_map_rgb(255,204,51),3);
                al_flip_display();
            }
            if (cadde_baslangic_sec[3] == 't' && cadde_yon_sec[3] == 'z')
            {
                ...
                al_draw_line(342,251,346,255,al_map_rgb(255,204,51),3);
                al_flip_display();
            ...
            if (cadde_baslangic_sec[3] == 'z' && cadde_yon_sec[3] == 't')
            {
                ...
                al_draw_line(290,190,286,194,al_map_rgb(255,204,51),3);
                al_flip_display();
            }
        }
    ...
    else if(N==2)
    {
        ...
        for(i=0; i<5; i++)
        {
            ...
            if (cadde_baslangic_sec[0] == 'x' && cadde_yon_sec[0] == 't')
            {
                ...
                al_draw_line(285,170,289,174,al_map_rgb(255,204,51),3);
                al_flip_display();
            ...
            if (cadde_baslangic_sec[1] == 'x' && cadde_yon_sec[1] == 'y')
            {
                ...
                al_draw_line(416,171,420,175,al_map_rgb(255,204,51),3);
                al_flip_display();
            }
            if (cadde_baslangic_sec[1] == 'y' && cadde_yon_sec[1] == 'x')
            {
            ...
            if (cadde_baslangic_sec[2] == 't' && cadde_yon_sec[2] == 'y')
            {
                ...
                al_draw_line(430,180,426,180,al_map_rgb(255,204,51),6);
                al_flip_display();
            ...
            if (cadde_baslangic_sec[2] == 'y' && cadde_yon_sec[2] == 't')
            {
                ...
                al_draw_line(274,180,278,180,al_map_rgb(255,204,51),6);
                al_flip_display();
            ...
            if (cadde_baslangic_sec[4] == 't' && cadde_yon_sec[4] == 'z')
            {
                ...
                al_draw_line(342,251,346,255,al_map_rgb(255,204,51),4);
                al_flip_display();
